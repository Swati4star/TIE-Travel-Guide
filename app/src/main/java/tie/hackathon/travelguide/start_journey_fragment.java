...
public class start_journey_fragment extends Fragment implements View.OnClickListener {
    ...
    LinearLayout tweet, music, jokes, video, news, books, friends,food,hangout,monuments,busstop,shopping,petrol,atm,hospital;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.video:
                i = new Intent(activity, Videos.class);
                startActivity(i);
                break;

            case R.id.jokes:
                i = new Intent(activity, Jokes.class);
                startActivity(i);
                break;
            ...
            case R.id.tweet:
                i = new Intent(activity, TweetMainActivity.class);
                startActivity(i);
                break;

            case R.id.news:
                i = new Intent(activity, News.class);
                startActivity(i);
                break;
